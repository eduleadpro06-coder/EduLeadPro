...
export default function OlaMapView({
    ...
    const htmlContent = `
        ...
        <head>
            ...
            <link href="https://cdn.jsdelivr.net/npm/olamaps-web-sdk@1.2.0/dist/style.css" rel="stylesheet" crossorigin="anonymous" />
            <style>
                html, body { 
        ...
        <body>
            <div id="map"></div>
            <script src="https://cdn.jsdelivr.net/npm/olamaps-web-sdk@1.2.0/dist/olamaps-web-sdk.umd.js" crossorigin="anonymous"></script>
            <script>
                let map;
                let olamaps;
                let markersMap = {};
