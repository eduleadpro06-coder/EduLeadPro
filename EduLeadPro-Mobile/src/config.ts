...
export const API_BASE_URL = Constants.expoConfig?.extra?.apiUrl || 'https://yonerra.vercel.app/api/v1/mobile';
export const WS_URL = Constants.expoConfig?.extra?.wsUrl || 'wss://yonerra.vercel.app';
