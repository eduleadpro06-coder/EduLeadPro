...
import { Baby, Users, UserPlus, Calendar, DollarSign, Settings as SettingsIcon, TrendingUp, Plus, Search, Clock, CheckCircle, UserCheck, LogOut, AlertTriangle, Phone, Mail, Eye, FileText, Download, Filter, InfoIcon, AlertCircle, User2, Trash2 } from "lucide-react";
        ...
        <div className="min-h-screen p-8 bg-gradient-to-br from-slate-50 to-blue-50">
            <div className="mb-6">
                <div className="flex items-center gap-3 mb-2">
                    ...
                    <h1 className="text-3xl font-bold text-gray-800">Daycare Management</h1>
                </div>
                <p className="text-gray-600 ml-14">Complete daycare operations and child care management</p>
            </div>
