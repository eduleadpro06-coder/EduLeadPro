    ...
    <div className="overflow-hidden whitespace-nowrap">
      ...
      >
        {duplicatedIcons.map((service, index) => (
          <div
            key={index}
            className={`flex-shrink-0 rounded-lg flex items-center justify-center p-4 mx-2 ${theme === 'light' ? 'bg-gradient-to-br from-blue-100 to-blue-200 text-blue-700 shadow-sm' : 'bg-gray-700/50 text-white'}`}
          >
            {service.icon}
          </div>
        ))}
...
const DashboardHighlights = () => {
  ...
  return (
    <section id="dashboard-highlights" className="py-24" style={{ background: theme === 'dark' ? '#010205' : 'transparent' }}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-5xl font-extrabold text-gray-900 dark:text-white">
            Dashboard Highlights
          </h2>
          <p className="mt-4 text-xl text-gray-700 dark:text-slate-300 max-w-2xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <motion.div
            className={`lg:col-span-2 p-12 rounded-3xl flex flex-col shadow-xl ${theme === 'light' ? 'bg-gradient-to-br from-white to-blue-50 border border-blue-200' : 'bg-[#0e0f12] border border-gray-700'}`}
          ...
          >
            <div className="mb-8">
              <AnimatedIconRow icons={topRowIcons} direction="left" theme={theme} />
            </div>
            <div className="mb-8">
              <AnimatedIconRow icons={bottomRowIcons} direction="right" theme={theme} />
            </div>
          ...
          >
            ...
            <div className={`px-6 py-12 border-t ${theme === 'light' ? 'bg-gradient-to-br from-blue-50 to-indigo-50 border-blue-200' : 'bg-[#0e0f12] border-gray-700'}`}>
              <div className="flex justify-between items-center mb-4">
                <div className="flex items-center gap-2">
                  <div className="bg-white p-1 rounded-md">
                    <BrainCircuit className="text-black" />
                  </div>
                  <span className="text-gray-900 dark:text-white font-bold text-lg">EduLead AI</span>
                </div>
              </div>
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-gray-900 dark:text-white">AI Assistant</span>
                </div>
                <div className="flex items-center gap-3">
                  <Sparkles size={20} className="text-fuchsia-400" />
                  <span className="text-gray-900 dark:text-white">AI Automation</span>
                </div>
              </div>
            </div>
          </motion.div>
          ...
          <div className="lg:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <div className="bg-gradient-to-br from-blue-50 to-purple-50 dark:from-purple-600 dark:to-rose-500 p-8 rounded-3xl h-full flex flex-col border border-gray-200 dark:border-transparent">
                <h3 className="text-gray-900 dark:text-white font-bold text-2xl">Urgent Tasks</h3>
                <p className="text-gray-700 dark:text-purple-200 mt-2 mb-6">
                  Key follow-ups and actions that need your immediate attention.
                </p>
                <div className="bg-white/80 dark:bg-black/30 backdrop-blur-sm p-6 rounded-2xl flex-grow space-y-4 border border-gray-200 dark:border-transparent">
                  <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                  ...
                  >
                    ...
                    <div className="w-full bg-gray-300 dark:bg-white/20 rounded-full h-1">
                      <motion.div
                  ...
                  >
                    <div className="flex items-center justify-between text-gray-900 dark:text-white mb-2">
                      ...
                      <span className="text-xs text-gray-600 dark:text-slate-300">3 pending</span>
                    </div>
                    <div className="w-full bg-gray-300 dark:bg-white/20 rounded-full h-1">
                      <motion.div
                        className="bg-gray-800 dark:bg-white h-1 rounded-full"
                  ...
                  >
                    <div className="flex items-center justify-between text-gray-900 dark:text-white mb-2">
                      ...
                      <span className="text-xs text-gray-600 dark:text-slate-300">Tomorrow</span>
                    </div>
                    <div className="w-full bg-gray-300 dark:bg-white/20 rounded-full h-1">
                      <motion.div
                        className="bg-gray-800 dark:bg-white h-1 rounded-full"
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <Card className={`p-8 rounded-3xl h-full flex flex-col shadow-xl ${theme === 'light' ? 'bg-gradient-to-br from-white to-blue-50 border border-blue-200' : 'bg-[#0e0f12] border border-gray-700'}`}>
                <div className="space-y-4 mb-6">
                  <motion.div
                    className={`flex items-center gap-4 p-3 rounded-lg ${theme === 'light' ? 'bg-gradient-to-r from-white to-blue-50 border border-blue-200 shadow-sm' : 'bg-white/5 border border-transparent'}`}
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.5, delay: 0.2 }}
                    viewport={{ once: true }}
                  >
                    ...
                    <div>
                      <h4 className="text-gray-900 dark:text-white font-semibold">Counselor</h4>
                  ...
                  >
                    ...
                    <div>
                      <h4 className="text-gray-900 dark:text-white font-semibold">Admin</h4>
                      <p className="text-xs text-gray-600 dark:text-slate-400">
                  ...
                  >
                    ...
                    <div>
                      <h4 className="text-gray-900 dark:text-white font-semibold">Marketing</h4>
                      <p className="text-xs text-gray-600 dark:text-slate-400">
